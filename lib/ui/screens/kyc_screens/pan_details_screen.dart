          ...
          child: Scaffold(
              ...
              body: Container(
                  ...
                  child: ListView(children: [
                    ...
                    Padding(
                      padding:  EdgeInsets.only(left:w1p * 6,right:w1p * 6, top: h1p * 3  ),
                      child: Container(
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              contentPadding:  EdgeInsets.symmetric(horizontal: w1p * 6,vertical: h1p * .5 ),
                    ...
                    DocumentUploading(maxWidth: maxWidth,maxHeight: maxHeight,),
                    InkWell(
                      onTap: () async {
                       await getIt<KycManager>().storePanCardDetails(panController.text);
                       Fluttertoast.showToast(msg:"successfully uploaded");
                       Navigator.pop(context);
                      },
                        child: Submitbutton(maxWidth: maxWidth, maxHeight: maxHeight,isKyc: true,content: "Save & Continue",))
